    ...
    <div>
      <div className="pt-[64px] flex justify-center relative">
        ...
        <div className="mt-10 max-w-5xl w-full mx-4 relative">
         ...
         <IconText color="red" text="Vision System" />
            ...
            <h6 className="text-[#6A6A6A] font-medium text-lg leading-[28px]">
              Experience the future of automation with LCS Controls' Machine
              Vision System. Our state-of-the-art technology harnesses the power
              of machine vision to optimize processes, improve accuracy, and
              drive efficiency by integrating Barcode scanners, cameras with our
              specialized software across industries.
            </h6>
