...
const slideData = [
  {
    ...
    description:
      "Built for the toughest mining environments—including coal, mineral, surface, and strip mining—our system ensures accurate payload monitoring, reduces operational risks, and improves overall site safety and efficiency across all loading methods.",
