  ...
  return (
    <div>
      ...
      <div className="relative w-full flex justify-center h-full z-3 px-4">
        <img
          className="absolute right-10 md:-top-50 min-[1024px]:!-top-100 xl:-top-120 2xl:h-auto h-60 sm:h-75 min-[1000px]:h-90 lg:h-100"
          src="/automotive/onboard-weighing/wheel-loader/wheel-loader.png"
        />
      </div>
    </div>
  );
