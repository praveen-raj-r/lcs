...
import wtCard from "@/assets/indicators/wt-10n/wt-10n-card.png";
import wt10dindaCard from "@/assets/indicators/wt-10n/wt-10ndin-da.png";
...
import wt10nImg from "@/assets/indicators/wt-10n/WT10N.png";
import wt10nImgGradient from "@/assets/indicators/wt-10n/wt-10n-gradient.png";
  ...
  return (
    <div>
      <div className="bg-repeat-x relative">
        ...
        <div className="py-5 md:py-24 pb-40 mx-2 rounded-b-2xl md:pb-50 flex justify-center bg-[radial-gradient(150.19%_150.19%_at_48.9%_-6.21%,#FFFFFF_0%,#FFFFFF_28.85%,#FFF1D0_52.88%,#0792B4_82.69%)]">
    ...
    <div className="max-w-5xl mx-auto px-4 w-full">
      <div className="py-30">
        <div className="space-y-6">
          <IconText text="Industrial" color="blue" />
...
const secondGridItems = [
  { description: "20-bit, ADC", title: "A/D Convertor" },
  ...
  return (
    <div className="bg-black text-center text-white">
      <div className="max-w-5xl mx-auto px-4 w-full py-10 space-y-10">
        ...
        <img src={wt10nImgGradient} className="mx-auto" />
...
const overviewCards = [
    ...
    specifications: [
      {
        ...
        value: "0-5V/0-10V/ 1-5V/2-10V / 0-20mA/ 4-20mA (16 bit) ",
      },
      ...
      { label: "Display Range", value: "±99999 ( 5 Digit )" },
      { label: "Conversion Speed", value: "10Hz " },
      { label: "A/D Converter", value: "20bit" },
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Class / Division", value: "III / 1 in 10000" },
      { label: "Display Range", value: "±99999 ( 5 Digit )" },
      { label: "Conversion Speed", value: "10kHz" },
      { label: "A/D Converter", value: "20bit" },
      { label: "Operating Voltage", value: "24V DC / 2A" },
      { label: "Number of Loadcell", value: "up to 8 (350 Ω)" },
      { label: "Loadcell Supply", value: "5VDC / 100 mA " },
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Communication", value: "RS485 (Half Duplex) / RS232 Ports" },
      {
        label: "Protocols",
        value: "LCS DUMP/ MODBUS RTU/ MODBUS TCP/ ASCII Protocol",
      },
      ...
      { label: "Number of Loadcell", value: "up to 8 (350 Ω)" },
      { label: "Loadcell Supply", value: "5VDC / 100 mA " },
      { label: "Mounting type", value: "DIN Rail" },
    ],
  },
];
