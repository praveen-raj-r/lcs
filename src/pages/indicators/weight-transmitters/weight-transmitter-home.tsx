...
import { wt10nCard, wt400vpCard } from "@/data/indicators/wt";

const WeightTransmitter = () => {
  return (
    <div className="relative bg-[#FFFFFF] overflow-hidden">
      <HeroSection />
      <div className="pt-[62px] max-w-5xl w-full mx-auto px-4">
        <div className="flex justify-between items-center">
          <IconText text="Industrial" color="#0792b4" />
          <CustomButton
            background=""
            color="#0792B4"
        ...
        >
          <div className="flex md:flex-row flex-col items-center gap-3 relative w-full max-w-5xl mx-auto px-4">
            <div className="flex flex-col gap-5 max-w-[565px] w-full">
              <IconText color="blue" text="Transmitters" />
      ...
      <Tabs defaultValue="wt-400vp">
        ...
        <div className="bg-[#F8F7F5] py-12.5 mt-12.5">
          <div className="max-w-5xl mx-auto w-full px-4">
            {[
              { value: "wt-400vp", content: wt400vpCard },
              { value: "wt-10n", content: wt10nCard },
            ].map((tabContent) => (
              <TabsContent value={tabContent.value}>
                <div className="grid lg:grid-cols-3 lg:gap-0 gap-10">
...
const GridCard = ({ card }: any) => {
  return (
    <div className="flex flex-col items-center text-[#1D1D1F] gap-4">
      ...
      <div className="flex flex-col items-center gap-[50px] lg:mt-19 border-b px-[54.5px] pb-11">
