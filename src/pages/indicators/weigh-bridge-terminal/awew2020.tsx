...
import awewHero from "@/assets/weighbridge-terminal/awew-hero.png";
import awew from "@/assets/weighbridge-terminal/awew.png";
import awewSpecGradient from "@/assets/weighbridge-terminal/awew-spec-gradient.png";
  ...
  return (
    <div className="bg-[#F8F7F5] md:py-25 py-10">
      <div className="max-w-5xl mx-auto px-4 w-full flex flex-col md:flex-row justify-between gap-10 md:gap-3">
        <div>
          <IconText text="Indicators" color="blue" />
...
const UniqueFeatures = () => {
  ...
  return (
    <div className="bg-[#E6F4F7] mt-25 py-25">
...
const specData = [
  {
    content:
      "Display LCD(2x16 char.) & 0.56” RED LED 6 Digit 7 Segments Display",
    paths: [
  ...
  {
    content: "Power Supply 230V AC / 1 Amps ",
    paths: [
  ...
  {
    content: "Loadcells 8 Loadcell 350 Ω",
    paths: [
  ...
  {
    content:
      "Interface 2 x Serial RS232 1x USB Data transfer 1x Centronics port for printer",
    paths: [
      "M5.96042 2H4.55039C3.62039 2 3.1504 3.13 3.8104 3.79L9.54038 9.52C11.1804 11.16 13.8304 11.16 15.4704 9.52L21.2004 3.79C21.8604 3.13 21.3904 2 20.4604 2H19.0504C18.2204 2 17.4204 2.33 16.8304 2.92L13.2504 6.5C12.8404 6.91 12.1804 6.91 11.7704 6.5L8.1904 2.92C7.5904 2.33 6.79042 2 5.96042 2Z",
  ...
  {
    content: "Digital Input/Output NA",
    paths: [
  ...
  {
    content: "AD Conversion 10 Samples/Sec (Type-20 bit Delta sigma)",
    paths: [
  ...
  {
    content: "Memory 65000 Data Memory",
    paths: [
      "M5.96042 2H4.55039C3.62039 2 3.1504 3.13 3.8104 3.79L9.54038 9.52C11.1804 11.16 13.8304 11.16 15.4704 9.52L21.2004 3.79C21.8604 3.13 21.3904 2 20.4604 2H19.0504C18.2204 2 17.4204 2.33 16.8304 2.92L13.2504 6.5C12.8404 6.91 12.1804 6.91 11.7704 6.5L8.1904 2.92C7.5904 2.33 6.79042 2 5.96042 2Z",
  ...
  {
    content: "Display Resolution 1/10,000",
    paths: [
    ...
    <div className="bg-[#E6F4F7]">
      ...
      >
        <div className="max-w-5xl mx-auto px-4 w-full py-25">
          ...
          <img src={awewSpecGradient} className="mx-auto mt-[70px]" />
          <div
            className={cn(
