...
import wi10nHeroImg from "@/assets/indicators/wi-10n/wi-10n.png";
import wi10nGradientImg from "@/assets/indicators/wi-10n/wi-10n-gradient.png";

import WI10NCard from "@/assets/indicators/wi-10n/wi-10n-card.png";
...
const overviewCards = [
  ...
  {
    title: "WI-10N-ETH",
    fullName: "[Ethernet Weight Indicator]",
    img: WI10NCard,
    features: [
      {
        img: da1,
  ...
  return (
    <div className="bg-black text-center text-white">
      <div className="max-w-5xl mx-auto px-4 w-full py-10 space-y-10">
        ...
        <img src={wi10nGradientImg} className="mx-auto" />
